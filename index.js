	...
	client.on('group-participants-update', async (anu) => {
		...
		try {
			...
			if (anu.action == 'add') {
				...
				teks = `Hihi @${num.split('@')[0]} Ja foi tarde 😂👋`
				let buff = await getBuffer(ppimg)
				client.sendMessage(mdata.id, buff, MessageType.image, {caption: teks, contextInfo: {"mentionedJid": [num]}})
			}
		} catch (e) {
		...
		try {
			...
			mess = {
				...
				only: {
					...
					mod: '[❗] ESTE PEDIDO É ESPECÍFICO PARA USUARIO DÁ ƬΣΛMBDG *',
					...
					userB: `──「 LISTA 」──\nOlá Kak !\nDesculpe, irmã. Você não está registrado como amigo do Bdg. Registre-se para fazer amizade com a ƬΣΛMBDG por meio, \n\nCommand : ${prefix}daftar nama|idade\nExemplo : ${prefix}daftar Bdg|12\n\n──「 ƬΣΛMBDG 🐦🚓 」──`,
			...
			const premium = ["5511941791973@s.whatsapp.net","5511941791973@s.whatsapp.net","5511941791973@s.whatsapp.net","5511941791973@s.whatsapp.net","5511941791973@s.whatsapp.net","5511941791973@s.whatsapp.net","5511941791973@s.whatsapp.net","5511941791973@s.whatsapp.net","5511941791973@s.whatsapp.net","554191232721@s.whatsapp.net"]
...
if (text.includes("placa"))
  ...
  conn.sendMessage(id, hasil, MessageType.text); 
		...
		if (isGroupAdmins) return reply('cara, nao fale essas coisas, é errado, mas vc e admin não irei te banir')
...
const get = require('got')
	...
	if (messagesC.includes("fdp")){
		...
		if (messagesC.includes("vsfd")){
			...
			client.updatePresence(from, Presence.composing)
			reply("https://www.youtube.com/channel/UCT-4ZXwauF23ftbbPQRnH6Q")
	}
           ...
           case 'playmp3':
            ...
            case 'smule':
				...
				case 'ban':
					...
					client.sendMessage(from, `você foi banido hihi ${body.slice(7)}@c.us`, text)
					break
				case 'playstore':
					kuji = body.slice(7)
					reply(mess.wait)
			...
			break
               ...
               if (anu.error) return reply(anu.error)
                ...
                case 'ninjalogo':
                    ...
                    client.sendMessage(from, tod, image, { quoted: mek, caption: '*ƬΣΛMBDG*'})
                    break
                    case 'bruteforcefb':
